                ...
                <div class="form-row">
                    ...
                    <div id="experienceFields" style="display:none;">
                        ...
                        <div class="form-row">
                            <div class="form-col">
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="uan-error" class="validation-message">Please enter a valid 12-digit UAN number</div>
                                </div>
                            </div>
                            <div class="form-col">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-col">
                                <label for="emp_relieving_letter">Relieving Letter (PDF only)</label>
                                <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-col">
                                <label for="emp_experience_certificate">Experience Certificate (PDF only)</label>
                                <div class="form-group">
...
<div class="form-section">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const uanRegex = /^\d{12}$/; // 12-digit UAN number
            ...
            // Validate education year sequence with strict year requirements
            ...
            form.addEventListener('submit', async function(e) {
                ...
                if (validateForm()) {
                    try {
                        ...
                        const response = await fetch('http://34.229.100.84:3071/save-employee', {
                            method: 'POST',
                            body: formData
                        });
...
function validateEmail() {
    ...
    // Function to validate Aadhaar input
    function validateAadhaar(input) {
        let cleaned = input.value.replace(/\D/g, ''); // Only digits
    ...
    // Function to validate PAN input
    function validatePAN(input) {
    const errorDiv = document.getElementById("emp_pan-error");
    ...
    // Event listeners
    aadhaarInput.addEventListener('input', () => validateAadhaar(aadhaarInput));
    panInput.addEventListener('input', () => validatePAN(panInput));
